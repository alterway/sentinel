...
class SwarmNodesConfig:
    ...
    def options(subparsers):
        ...
        parser.add_argument('-b', '--backend', default='consul',
                            help='To configure the backend to register services, only consul for now.')
        parser.add_argument('-o', '--orchestrator', default='swarm',
                            help='To configure the cluster docker orchestrator, only swarm for now')
        parser.add_argument('-t', '--target', default='127.0.0.1:8500',
        ...
        parser.add_argument('-ll', '--log-level', help='Log level', default=DEFAULT_LOG_LEVEL)
